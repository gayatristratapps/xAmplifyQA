...
public class RedistributeEventCampaign  {
	...
	public void hoverRedistributecampaigns_event() throws InterruptedException, AWTException {
		...
		Thread.sleep(6000);
		  ...
		  WebElement s_select = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(properties.getProperty("check_contact_list")))); 
		  s_select.click();
		 Thread.sleep(5000);	
...
//		Thread.sleep(4000);
       ...
       /*driver.get("https://xamplify.co/home/campaigns/manage");
		 ...
		 * "partner_eve_redistribute_eventtab"))).click(); // click on // // event // //
		 * tab Thread.sleep(38000); logger.info("Event tab clicked successfully");
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 ...
		 * Thread.sleep(4000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty("partneracc_m_eve_edit")))
		 * .click(); Thread.sleep(4000);
		 * logger.info("Clicked on the edit icon successfully");
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_edit_folder"))).click(); Thread.sleep(4000);
		 * logger.info("Clicked on the edit folder successfully");
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_edit_updatefolder"))).click(); Thread.sleep(4000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_edit_update"))).click(); Thread.sleep(4000);
		 * logger.info("Clicked on the update button successfully");
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_edit_update_close"))).click(); Thread.sleep(9000);
		 * 
		 * }
		 * 
		 * @Test(priority = 2, enabled = true) public void pac_manage_sendpreviewemail()
		 ...
		 * send data sndata.sendKeys(Keys.ENTER);
		 * 
		 * Thread.sleep(7000);
		 * 
		 ...
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_sendbutton"))).click(); // click on the // send button
		 * Thread.sleep(4000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 ...
		 * 
		 * @Test(priority = 3, enabled = true) public void pac_manage_Inivitemore()
		 * throws InterruptedException, SQLException {
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partner_manage_eve_gearicon"))).click();
		 ...
		 * pac_manage_preview_analytics() throws InterruptedException, SQLException {
		 * 
		 * driver.get("https://xamplify.co/home/campaigns/manage");
		 * 
		 * Thread.sleep(7000);
		 ...
		 * Thread.sleep(4000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty("partneracc_m_eve_preview"
		 * ))).click();
		 * 
		 * logger.info("Clicked on preview successfully"); Thread.sleep(8000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_preview_analytics"))).click();
		 * 
		 ...
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_preview_emlinfo"))).click();
		 * 
		 * logger.info("Clicked on emailinfo  successfully"); Thread.sleep(7000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_preview_emlinfo_cls"))).click();
		 * 
		 ...
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_preview_listinfo"))).click();
		 * 
		 ...
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_preview_listinfo_cls"))).click();
		 * 
		 * logger.info("listinfo closed successfully");
		 * 
		 * driver.findElement(By.xpath(properties.getProperty("partneracc_m_eve_invites"
		 * ))).click();
		 * 
		 ...
		 * 
		 * driver.findElement( By.xpath(properties.getProperty(
		 * "partneracc_m_eve_invites_whohaventopned_remainder_subject")))
		 * .sendKeys("subject");
		 * 
		 * Thread.sleep(5000);
		 * 
		 ...
		 * .sendKeys("Please open the email[Remainder]"); Thread.sleep(5000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 ...
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_invites_Notyet"))).click(); Thread.sleep(5000);
		 * 
		 * WebElement evesearch = driver .findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_invites_Notyet_search"))); evesearch.sendKeys("gayatri");
		 * evesearch.sendKeys(Keys.ENTER);
		 * 
		 * Thread.sleep(7000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_invites_Notyet_export"))).click(); Thread.sleep(5000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_invites_Notyet_excel"))).click(); Thread.sleep(5000);
		 * 
		 * logger.info("Export to excel done successfully");
		 * 
		 * Thread.sleep(5000);
		 * 
		 * WebElement invite_yes = driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_invites_yes")));
		 * 
		 ...
		 * }
		 * 
		 * else { logger.info("Unable to click Yes tile  due to count is '0' ");
		 * 
		 * } Thread.sleep(5000);
		 * 
		 ...
		 * }
		 * 
		 * else { logger.info("Unable to click leads tile  due to count is '0' ");
		 * 
		 * } Thread.sleep(5000);
		 * 
		 ...
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_invites_total_download"))).click(); Thread.sleep(5000);
		 * 
		 ...
		 * "partneracc_m_eve_invites_total_search")));
		 * eve_tot_search.sendKeys("gayatri"); eve_tot_search.sendKeys(Keys.ENTER);
		 * 
		 * Thread.sleep(7000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_invites_total_cls"))).click(); Thread.sleep(5000);
		 * 
		 * }
		 * 
		 * else { logger.info("Unable to click Total tile due to count is '0' ");
		 * 
		 * } Thread.sleep(5000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 ...
		 * .findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_Campaignanalytics"))); eve_analytics.sendKeys("gayatri");
		 * eve_analytics.sendKeys(Keys.ENTER); Thread.sleep(5000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_Campaignanalytics_gearicon"))).click(); Thread.sleep(5000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_Campaignanalytics_gearicon_excel"))) .click();
		 * Thread.sleep(5000);
		 * 
		 * logger.info("Download excel successfully in Campaign Analytics section");
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_emailid_click"))).click(); Thread.sleep(5000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "partneracc_m_eve_emailid_registerlead"))).click(); Thread.sleep(5000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_registerlead_firstname"))).sendKeys(" " + " FName"); // first // name
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_registerlead_lastname"))).sendKeys(" " + " LName"); // last // name
		 * Thread.sleep(2000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_registerlead_companyname"))).sendKeys(" " + " cname"); // company //
		 * name Thread.sleep(1000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_registerlead_phoneno"))).sendKeys(" " + " 912345678"); // phone //
		 * number Thread.sleep(5000);
		 * 
		 * Select drpstage = new Select(
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_registerlead_selectstage")))); // select stage
		 * drpstage.selectByValue("4551");
		 * 
		 * Thread.sleep(5000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_registerlead_address"))).sendKeys(" " + " Address"); // address
		 * Thread.sleep(1000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty("mevec_registerlead_city")
		 * )).sendKeys(" " + " city"); // city Thread.sleep(1000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty("mevec_registerlead_state"
		 * ))).sendKeys(" " + " state"); // state Thread.sleep(1000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_registerlead_postalcode"))).sendKeys(" " + " 534342"); // zipcode
		 * Thread.sleep(1000);
		 * 
		 * Select eve_drpCountry = new Select(
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_registerlead_selectcountry")))); // country
		 * eve_drpCountry.selectByValue("India");
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_registerlead_submit"))).click(); // submit
		 * 
		 * logger.info("Event Lead submitted Successfully");
		 * 
		 * Thread.sleep(5000);
		 * driver.findElement(By.xpath(properties.getProperty("mevec_opportunities"))).
		 * click(); // hover to opportunities Thread.sleep(3000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty("mevec_oppo_manageleads"))
		 * ).click(); // redirect to manage // leads Thread.sleep(5000);
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_oppo_manageleads_registerdealclick"))).click(); // Register // Deal //
		 ...
		 * .findElement(By.xpath(properties.getProperty(
		 * "mevec_oppo_mleads_rdeal_selectstage"))); // select stage
		 * eve_selectstage.sendKeys("Opened"); Actions keyDown = new Actions(driver);
		 * keyDown.sendKeys(Keys.chord(Keys.DOWN, Keys.DOWN)).perform();
		 * 
		 * Thread.sleep(3000); logger.info("Selected stage in dropdown Successfully");
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_oppo_mleads_rdeal_title"))).sendKeys("Title"); // title // field
		 * 
		 * Thread.sleep(3000); WebElement eve_selectstage2 = driver
		 * .findElement(By.xpath(properties.getProperty(
		 * "mevec_oppo_mleads_rdeal_selectdeal"))); // select stage
		 * eve_selectstage2.sendKeys("Select Dealtype"); Actions keyDown2 = new
		 * Actions(driver); keyDown2.sendKeys(Keys.chord(Keys.DOWN)).perform();
		 * 
		 ...
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_oppo_mleads_rdeal_amount"))).sendKeys("2345"); // amount
		 * Thread.sleep(3000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_oppo_mleads_rdeal_calendar"))).click(); // select // calendar
		 * 
		 * Thread.sleep(7000);
		 * 
		 * WebElement reve_calendar = driver
		 * .findElement(By.xpath(properties.getProperty(
		 * "mevec_oppo_mleads_rdeal_selectdate")));
		 * 
		 * if (reve_calendar.isDisplayed()) {
		 * 
		 * reve_calendar.click(); // select current date
		 * 
		 * Thread.sleep(4000); logger.info("Selected Date in Calendar Successfully");
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_oppo_mleads_rdeal_addcomments"))).click(); // add // comments //
		 * button Thread.sleep(3000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_oppo_mleads_rdeal_commenttitle"))) .sendKeys("commtitle"); // comment
		 * title Thread.sleep(3000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_oppo_mleads_rdeal_comment"))).sendKeys("comment"); // comment // text
		 * // area
		 * 
		 * Thread.sleep(3000);
		 * 
		 * driver.findElement(By.xpath(properties.getProperty(
		 * "mevec_oppo_mleads_register_deal"))).click(); // click // for // register //
		 * deal // button Thread.sleep(5000); String s =
		 * driver.findElement(By.xpath(properties.getProperty("mevec_registerdeal_msg"))
